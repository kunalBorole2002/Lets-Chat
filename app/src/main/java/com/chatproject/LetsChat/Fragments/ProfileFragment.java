...
public class ProfileFragment extends Fragment {
    ...
    TextView profile_tv;
    EditText username, bio_et, require_et;
    ImageView edit_img;
    Button save;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        require_et = view.findViewById(R.id.requirement_et);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                require_et.setEnabled(false);

                reference.child("bio").setValue(bio_et.getText().toString().trim());

                reference.child("requirement").setValue(require_et.getText().toString().trim());
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                require_et.setText(user.getRequirement());
