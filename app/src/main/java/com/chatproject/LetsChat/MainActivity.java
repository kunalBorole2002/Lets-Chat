...
import com.chatproject.LetsChat.Adapter.OnItemClick;
import com.chatproject.LetsChat.Fragments.ChatsFragment;
import com.chatproject.LetsChat.Fragments.ProfileFragment;
import com.chatproject.LetsChat.Fragments.UsersFragment;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case  R.id.logout:
                ...
                startActivity(new Intent(MainActivity.this, StartActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP |Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
                return true;
        }
